...
#' \code{calc_cf_log_m_2} is a function that calculates the
...
#' calc_cf_log_m_2 -> function(simple_data,shocks,parameters)
...
#C_hat_1             C_hat_2
#1 -10.078556263269640 -10.078556263269636
#2 -14.169851380042463 -14.169851380042463
